//! Representation command - assemble a bounded working-memory context
...
/// Execute the representation command
///
/// Builds a working representation combining recent memories, semantic matches,
/// derived insights, digests, and contradictions for the given perspective and query.
pub async fn execute(
    ...
    println!(
        "Working Representation ({} items, max {}) — {} observing {}",
        total, max_items, perspective.observer, perspective.subject
    );
    println!("=========================================\n");
    ...
    if !representation.recent.is_empty() {
